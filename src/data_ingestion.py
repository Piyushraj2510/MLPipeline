...
#logging configuration for log generation
...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) ->None:
    ...
    try:
        ...
        logger.debug('Train and test dataset saved to %s',raw_data_path)
    except Exception as e:
        logger.error('Unexpected error while the saving the data: %s',e)
        raise    
